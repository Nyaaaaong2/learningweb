                         ...
                         <div class="login-form">
                             <form action="_userchange.php" method="post">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input name="name" type="text" class="form-control" placeholder="* Enter Your Name" value="<?php echo $_SESSION['name'];?>">
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input name="address" type="text" class="form-control" placeholder="Enter Your Address" value="<?php echo $_SESSION['address'];?>" >
                                 </div>

                                 <button type="summit" class="btn oneMusic-btn mt-30" >Submit</button>
                             </form>
                         </div>
                     </div>
                 </div>
